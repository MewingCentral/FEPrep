  ...
  return (
    <main>
      <div className="flex h-full flex-col rounded-xl">
        {/* top right */}
        <div className="top-section justify-left flex w-full grow flex-row gap-2 rounded-xl border p-4">
        ...
        {/* bottom right */}
        <div className="bottom-section mt-4 w-full rounded-xl border">
